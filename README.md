...
The Screenshot plugin allows your application to take screenshots of the current screen and save them into the phone. Forked from [https://github.com/gitawego/cordova-screenshot.git](here) to use the MediaStore Android API to save images.
...
```
cordova plugin add https://github.com/Mforcen/cordova-screenshot.git
```
